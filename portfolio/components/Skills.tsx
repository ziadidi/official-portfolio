  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="absolute top-36 tracking-[3px] uppercase text-slate-400 text-sm">
            hover over the skills to display <span className="italic lowercase underline">expertise.</span>
        </h3>
